  ...
  return (
    <>
      <HeroSection>
        ...
        <div className="container">
          <div className="text">
            ...
            <p>
              MuuPunks NFT 
              launching on the 16th of November, 2022 on the Muu blockchain
              for 2000000 MUU(MuuChain) each!
            </p>
      ...
      <AboutSection>
        ...
        <p>
          You are welcome to explore MUUPUnks NFTs, which are digitally altered
          pieces of masterful arts. By placing the subjects of these
          arts in new digitally imagined environments, we have given more
          room to the expression of the different realities of our Muuchain Experience.
        </p>

        <p>
          We also intends on building the largest NFT Community out of Muuchain,
